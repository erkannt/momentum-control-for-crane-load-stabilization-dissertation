...
omega_x = ( - theta21.diff(t)*(-sin(theta21)*sin(theta22)*cos(theta23)
                        - sin(theta23)*cos(theta21))
            + theta22.diff(t)*(-sin(theta21)*sin(theta22)*sin(theta23)
                        + cos(theta21)*cos(theta23)) )
omega_y = ( - theta21.diff(t)*cos(theta22)*cos(theta23)
            + theta22.diff(t)*sin(theta23)*cos(theta22) )
omega_z = ( - theta21.diff(t)*(-sin(theta21)*sin(theta23)
                        + sin(theta22)*cos(theta21)*cos(theta23))
            + theta22.diff(t)*(sin(theta21)*cos(theta23)
                        + sin(theta22)*sin(theta23)*cos(theta21))
            + theta23.diff(t) )
...
solvedeuleq = solve(euleq, [udot11, udot12, udot21, udot22, udot23],
