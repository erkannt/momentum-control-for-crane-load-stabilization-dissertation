...
abstract: 
  ...
  What is currently missing is a robotics approach that addresses the very large work envelope that constitutes a construction site.
  ...
  An general control strategy is laid out and a simple PD-based controller designed.
...
abstractde:
  ...
  Diese Arbeit untersucht daher die Praktikabilität von Roboter und andere kinematische Systeme, an einem normalen Kran hängend zu betreiben.
  Um dies sinnvoll tun zu können, muss der Kranhaken und der darunter hängende Roboter stabilisiert werden.
  Der in dieser Arbeit untersuchte Ansatz verwendet Kontrollmomentgyroskope (CMG), welche eine etablierte Technologie zur Stabilisierung von Schiffen und Neuausrichtung von Raumfahrzeugen sind.
  ...
  Die Simulationen zeigen nicht nur das Potenzial des Ansatzes, sondern ermöglichen es der Arbeit auch, Dimensionierungsrichtlinien zu entwickeln und kritische Bereiche für die zukünftige Forschung zu identifizieren.
