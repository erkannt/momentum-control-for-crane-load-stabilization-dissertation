...
The effect of this can vary depending of the exitation/inital conditions of the simulation (see @Fig:2d-3d-comparison-large-exitation-spherical and @Fig:2d-3d-comparison-small-exitation in the appendix).
...
The torque generated by the CMGs ($\tau$) directly changes the angular accelleration of the lower link.
For the two-dimensional model the necessary modifcations to the equations of motion are straightforward:
...
Note how this encompasses _all_ torques produced by the CMG, thereby cleanly seperating the crane and CMG models easing their respective developments.
