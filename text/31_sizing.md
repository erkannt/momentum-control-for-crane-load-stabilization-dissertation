...
See [@LeveSpacecraftMomentumControl2015, sec. 3.1] for an in depth discussion of this and how the duration of the jerk- and acceleration-limited regime can be derived from the relationship between max jerk, accelleration and velocity.
