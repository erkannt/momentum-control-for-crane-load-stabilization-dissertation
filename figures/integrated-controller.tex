...
% Process Nodes
    ...
    \node [block, right=of pe-sum, align=center] (plattform-controller) {Plattform\\ Controller};
    ...
    % Robot Model
    \node [block, above=of plattform-controller, align=center] (robot-model) {Robot\\ Model};
    ...
    % Robot Controller
    \node [block, above=of robot-model, align=center] (robot-controller) {Robot\\ Controller};
    ...
    % Robot
    \node [block, above=of cmg-controller] (robot) {Robot};
    ...
    \node [block, above=25mm of robot, align=center] (coord-model) {Pendulum + Robot\\ Coordinate Model};
    ...
    \node [block, below=25mm of pendulum, align=center] (sensor1) {Pendulum\\ Sensor};
    \node [block, above=40mm of pendulum.south, align=center] (sensor2) {Pendulum\\ Sensor};
...
% Crane Nodes
    ...
    \node [block, right=of crane-drives, align=center] (crane) {Gantry\\ and Winch};
    ...
    \node [block, below=of crane, align=center] (crane-sensor) {Crane Drive\\ Sensor};
%Crane Loop
